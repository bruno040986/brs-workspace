...
export const systemConfigNavEntries = [
  ...
  { resource: 'sistema-config-gateways', href: '/rh/parceiros/config/provedores/gateways' },
  ...
  { resource: 'sistema-config-banners', href: '/rh/parceiros/config/provedores/banners' },
  ...
  { resource: 'sistema-config-if-credito', href: '/rh/parceiros/config/provedores/if-credito' },
  { resource: 'sistema-config-motor-credito', href: '/rh/parceiros/config/provedores/motor-credito' },
  { resource: 'sistema-config-figurinhas-gifs', href: '/rh/parceiros/config/provedores/figurinhas-gifs' },
...
const exactRouteRules: Record<string, RouteAccessRule> = {
  ...
  '/rh/parceiros/config/provedores/banners': any([view('sistema-config-banners')]),
  ...
  '/agente-corban/cadastros-recebidos': any([view('agente-corban-cadastros-recebidos')]),
  '/agente-corban/solicitacoes': any([view('agente-corban-solicitacoes')]),
  ...
  '/agente-corban/certificacoes': any([view('workspace-certificacoes')]),
  '/agente-corban/templates-mensagens': any([view('workspace-templates-mensagens')]),
  ...
  '/simulador-portabilidade': any([view('operacional-simulador-portabilidade')]),
  '/api/nvti/upload': any([include('operacional-nvti')]),
  '/rh/parceiros/config/provedores/nvti': any([view('sistema-config-nvti')]),
  '/rh/parceiros/config/provedores/gateways': any([view('sistema-config-gateways')]),
  ...
  '/operadoras-telefonia': any([view('workspace-operadoras-telefonia')]),
  ...
  '/gestao-leads/higienizacao-amigoz': any([view('alvoconsig-higienizacao-amigoz')]),
  '/api/if-higienizacao/upload': any([include('alvoconsig-higienizacao-amigoz')]),
  '/api/if-higienizacao/lotes': any([view('alvoconsig-higienizacao-amigoz')]),
  '/alvoconsig/motor-credito': any([view('alvoconsig-motor-credito')]),
  ...
  '/gestao-leads/consulta-fydigital': any([view('alvoconsig-consulta-fydigital')]),
  ...
  '/rh/parceiros/config/provedores/if-credito': any([view('sistema-config-if-credito')]),
  '/rh/parceiros/config/provedores/motor-credito': any([view('sistema-config-motor-credito')]),
